...
import static com.zhj.zhjsdkcustomized.ble.bluetooth.BluetoothUUID.READ;
import static com.zhj.zhjsdkcustomized.ble.bluetooth.BluetoothUUID.SERVICE;
import static com.zhj.zhjsdkcustomized.ble.bluetooth.BluetoothUUID.SERVICE_PAIR;
import static com.zhj.zhjsdkcustomized.ble.bluetooth.BluetoothUUID.WRITE;
    ...
    protected void initView() {
        ...
        mBluetoothLe.setOnConnectListener(TAG, new OnLeConnectListener() {
            ...
            public void onServicesDiscovered(BluetoothGatt bluetoothGatt) {
                //Call without displaying pairing code
                isConnecting = false;
...
//                } );
    ...
    private Dialog showPairingDialog(){
        ...
        DisplayMetrics d = this.getResources().getDisplayMetrics(); // Get screen width and height
    ...
    private void scan() {
        UUID[] uuids2 = new UUID[]{SERVICE,READ,WRITE};
        mBluetoothLe.setScanPeriod(5000)
                .setReportDelay(0)
//                .setScanWithDeviceName("DreamIT-759E")
//                .setScanWithDeviceAddress("E6:78:9C:CE:7B:80")
                .setScanWithServiceUUID(uuids2)
...
//            showToast(getResources().getString(R.string.connect_device_str));
    ...
    protected void onDestroy() {
        super.onDestroy();
        mBluetoothLe.stopScan();
        //Log off monitoring according to TAG to avoid memory leakage
