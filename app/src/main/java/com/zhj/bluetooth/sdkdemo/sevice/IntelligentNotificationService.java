...
public class IntelligentNotificationService extends NotificationListenerService {
    ...
    public void onCreate() {
        ...
        Log.d("FF332","Start reminder notification service");
...
//                sendText(notification, (byte) BleContant.MSG_TYPE_OTHER, "other");
                    if(listName.size() == 0) {
                        //Add the first downloaded app for the first time
                        if(pkgName != null) {
                        ...
                        for (int i = 0; i < listName.size();i++){
                            if(pkgName != null) {
                                //Judge the existence of equality and change the variable value
...
//        }
        ...
        LogUtil.d("Sent reminder information, mTitle:" + title + ",mText:" + text + ",mType:" + type);
//        if (TextUtils.isEmpty(text)) {
//            return;
//        }
...
//    }
    ...
    public void addMessage(int type,String mTitle,String mText){
        LogUtil.d("The electricity is back.");
