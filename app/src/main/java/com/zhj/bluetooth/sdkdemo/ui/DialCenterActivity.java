...
import com.zhj.zhjsdkcustomized.bean.DialInfoList;
...
import com.zhj.zhjsdkcustomized.net.NetConnect;
import com.zhj.zhjsdkcustomized.util.Constants;
import com.zhj.zhjsdkcustomized.util.FileUtil;
...
public class DialCenterActivity extends BaseActivity implements BaseAdapter.OnItemClickListener {
    ...
    protected void initView() {
        super.initView();
        titleName.setText(getResources().getString(R.string.set_dial));
        ...
        NetConnect.getDialCenterByModel(this, "T22Q19N7", new BleCallbackWrapper() {
            ...
            public void complete(int resultCode, Object o) {
                if(resultCode == Constants.BLE_RESULT_CODE.SUCCESS){
                    ...
                    LogUtil.d("getting information failure");
                }
            }
    ...
    private void sendDialToDevice() {
        BleSdkWrapper.sendDailCenter(sendDial.getCustomId(), dialFile, new OnLeWriteCharacteristicListener() {
            ...
            public void onSuccess(HandlerBleDataResult handlerBleDataResult) {
                ...
                tvProgress.setText(getResources().getString(R.string.send_progress)+progress);
            }
            ...
            @Override
            public void onFailed(WriteBleException e) {
                LogUtil.d("Upgrade failed:"+e.toString());
            }
        });
    }
}
